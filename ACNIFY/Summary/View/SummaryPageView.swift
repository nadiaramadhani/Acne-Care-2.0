                ...
                ScrollView{
                    ...
                    if viewModel.selectedAcneLog != nil {
                        VStack{
                            ...
                            DropdownView(productDayNames: viewModel.productUsedDayNames, productNightNames: viewModel.productUsedNightNames)
...
struct DropdownView: View{
    var productDayNames: [String]
    var productNightNames: [String]
                ...
                DisclosureGroup(isExpanded: $isExpandedNight)
                {
                    VStack{
                        HStack{
                            ...
                            ForEach(productNightNames, id:\.self){ name in
                                Text (name)
                                    .foregroundColor(.white)
                            }
                    ...
                    HStack{
                        Image("nightSummary")
                            .resizable()
                            .frame(width: 28, height: 28)
                        ForEach(productDayNames, id:\.self){ name in
                            Text (name)
                                .foregroundColor(.white)
                        }                        }
                }
